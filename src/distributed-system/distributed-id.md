...
![](./images/distributed-id/id-after-the-sub-table-not-conflict.png)

### 分布式 ID 需要满足哪些要求?

![](./images/distributed-id/distributed-id-requirements.png)
...
![数据库主键自增](./images/distributed-id/the-primary-key-of-the-database-increases-automatically.png)
...
![数据库号段模式](./images/distributed-id/database-number-segment-mode.png)
...
![](./images/distributed-id/nosql-distributed-id.png)
...
![](./images/distributed-id/mongodb9-objectId-distributed-id.png)
...
![](./images/distributed-id/rfc-4122-uuid.png)
...
![Version 1 版本下生成的 UUID 的示例](./images/distributed-id/version1-uuid.png)
...
![Snowflake 示意图](./images/distributed-id/snowflake-distributed-id-schematic-diagram.png)
...
![](./images/distributed-id/uidgenerator-distributed-id-schematic-diagram.png)

可以看出，和原始 Snowflake(雪花算法)生成的唯一 ID 的组成不太一样。并且，上面这些参数我们都可以自定义。

UidGenerator 官方文档中的介绍如下：

![](./images/distributed-id/uidgenerator-introduction-official-documents.png)
...
![](./images/distributed-id/up-5c152efed042a8fe7e13692e0339d577f5c.png)
...
![](./images/distributed-id/up-4afc0e45c0c86ba5ad645d023dce11e53c2.png)
...
![](./images/distributed-id/up-53f74cd615178046d6c04fe50513fee74ce.png)
