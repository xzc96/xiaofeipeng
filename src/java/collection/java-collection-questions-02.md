...
![Hashtable 的内部结构](./images/jdk1.7_hashmap.png)

<p style="text-align:right;font-size:13px;color:gray">https://www.cnblogs.com/chengxiao/p/6842045.html></p>

**JDK1.7 的 ConcurrentHashMap** ：

![Java7 ConcurrentHashMap 存储结构](./images/java7_concurrenthashmap.png)
...
![Java8 ConcurrentHashMap 存储结构](./images/java8_concurrenthashmap.png)
