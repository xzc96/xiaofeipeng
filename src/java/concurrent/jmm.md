...
![CPU 缓存模型示意图](./images/cpu-cache.png)
...
![缓存一致性协议](./images/cpu-cache-protocol.png)
...
![happens-before 与 JMM 的关系](./images/image-20220731084604667.png)
